...
bool __stdcall OutputXRDxfProvinceRoad(const char* fpath, int diseaseNum, Disease_C* disease, GridDisease_C* gridDisease,int direction)
{
 	string str = fpath;
	...
	hnOutputRoadDiseaseXRProvinceRoad m_outputXR(500);
