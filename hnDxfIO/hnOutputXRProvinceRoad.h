...
extern "C" __declspec(dllexport) bool __stdcall OutputXRDxfProvinceRoad(const char* fpath, int diseaseNum, Disease_C* disease, GridDisease_C* gridDisease,int direction);
