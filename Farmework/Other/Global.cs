...
//using ProjectLog;
namespace Framework.Other.MyGlobal
{
   public class Global
    {
      ...
      //  public static ProjectTraceListener g_log = null;
        ...
        /// 显示在界面上 添加了具体的版本信息
        /// </summary>
        public static string[] g_ParmStyles_Show = { "等级公路2007", "城镇道路", "北京农村公路", "等级公路2018(5210)", "等级公路2001", "上海城市道路", "辽宁农村公路", "广西农村路", "重庆农村路", "湖南农村路","低等级农村公路(5211)"};
    }
}
